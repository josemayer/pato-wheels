...
class Agent:
    def __init__(self, env):
        ...
        self.model_od = tensorflow.keras.models.load_model('assignments/challenge/models/od.h5')
        
        # load model of dodge
        self.model_dodge = tensorflow.keras.models.load_model('assignments/challenge/models/ddg.h5')
        ...
        self.model_lf = tensorflow.keras.models.load_model('assignments/challenge/models/lf.h5')
